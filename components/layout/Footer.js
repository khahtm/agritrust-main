                ...
                <div className="position-relative newsletter-inner">
                  <div className="newsletter-content">
                    ...
                    <p className="mb-45">
                      ...
                      <span className="text-brand">Agritrust</span>
                    </p>
          ...
          <div className="container">
            <div className="row">
              <div className="col-lg-1-5 col-md-4 col-12 col-sm-6 mb-md-4 mb-xl-0">
                ...
                >
                  <div className="banner-icon">
                    <img src="/assets/imgs/theme/icons/icon-7.svg" alt="nest" />
                  </div>
                  <div className="banner-text">
                    <h3 className="icon-box-title">Giá tốt nhất</h3>
                    <p>Chỉ từ 200.000đ</p>
                  </div>
                </div>
              </div>
              <div className="col-lg-1-5 col-md-4 col-12 col-sm-6">
                ...
                >
                  <div className="banner-icon">
                    <img src="/assets/imgs/theme/icons/icon-8.svg" alt="nest" />
                  </div>
                  <div className="banner-text">
                    <h3 className="icon-box-title">Giao hàng miễn phí</h3>
              ...
              <div className="col-lg-1-5 col-md-4 col-12 col-sm-6">
                ...
                >
                  <div className="banner-icon">
                    <img src="/assets/imgs/theme/icons/icon-9.svg" alt="nest" />
                  </div>
                  <div className="banner-text">
                    <h3 className="icon-box-title">Deal hời mỗi ngày</h3>
              ...
              <div className="col-lg-1-5 col-md-4 col-12 col-sm-6">
                ...
                >
                  ...
                  <div className="banner-text">
                    <h3 className="icon-box-title">Phủ sóng rộng khắp</h3>
              ...
              <div className="col-lg-1-5 col-md-4 col-12 col-sm-6">
                ...
                >
                  ...
                  <div className="banner-text">
                    <h3 className="icon-box-title">Dễ dàng đổi trả</h3>
                    <p>Within 30 days</p>
                  </div>
                </div>
              </div>
                ...
                >
                  ...
                  <ul className="contact-infor">
                    <li>
                      ...
                      <span>Thành phố Thủ Đức, Hồ Chí Minh</span>
                    </li>
                    <li>
                      <img
          ...
          <div className="row align-items-center">
            ...
            <div className="col-xl-4 col-lg-6 col-md-6">
              <p className="font-sm mb-0">
                &copy; 2024, <strong className="text-brand">Agritrust</strong>
                <br />
                All rights reserved
              </p>
            </div>
